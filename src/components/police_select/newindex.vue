  ...
  <div class="el-select"
    ...
    <transition name="el-zoom-in-top">
      ...
      <el-select-menu ref="popper"
        ...
        <div wrap-class="el-select-dropdown__wrap"
...
import { getDutyPolice } from '../depart_police_select/service'
export default {
  ...
  methods: {
    getPoliceList () {
      getDutyPolice({ deptId: this.prisonId }).then(res => {
        this.optionList = res
      })
    },
    getPrisonData () {
      ...
      if (PrisonId) {
        this.axios
          .get(this._global.userUrl + '/compose/getChildrenTreeByParentId/' + PrisonId)
          .then(response => {
    ...
    doDestroy () {
      console.log('this.$refs.popper.doDestroy()')
