 ...
 * @LastEditors: zhuhao
 * @LastEditTime: 2019-12-05 11:34:23
 -->
      ...
      if (this.chart != null) {
        if (dataList.length == 0) {
          ...
          this.chart.setOption({
            ...
            color: ['#0368CA', '#3CB9FE', '#74D2FF', '#F8B72B', '#EB5D1E'],
