 ...
 * @LastEditTime: 2020-03-31 14:28:34
 * @LastEditors: zhuhao
 -->
...
<template>
  <menuTree :menuList="['工作辅助','文件下发与报送']">
    <div slot="heade_btn" class="yn_page_btn">
      ...
      <div class="link_btn">收文记录</div>
      <div class="dis_btn" @click="tosend">发文记录</div>
    ...
    >
      <div slot="searchCondition">
        <el-form ref="searchForm" class="yn_form" :model="params" inline>
          ...
          <!-- <el-form-item label="收发类型:" prop="dispatchType">
            <el-select class="yn_ipt" v-model="params.dispatchType" @change="typeChange">
              <el-option
    ...
    <!-- 查看反馈 -->
    <el-dialog title="反馈详情" class="yn_dialog" center :visible.sync="backFlag" width="60%">
      <el-table :data="backList" class="yn_table">
        ...
        <el-table-column label="操作" v-if="params.dispatchType==1">
          <template slot-scope="scope">
            <el-button type="text" v-if="scope.row.fbStatus==1" @click="openBack(scope.row)">进行反馈</el-button>
          </template>
        </el-table-column>
      </el-table>
    </el-dialog>
...
export default {
  ...
  methods: {
    ...
    getData() {
      ...
      parma.rePrisonId = this.prisonId
