 ...
 * @LastEditors  : zhuhao
 * @LastEditTime : 2020-01-06 10:11:10
 -->
<template>
  <el-dialog title="学习详情" center class="yn_dialog" :visible="Visible" width="60%" @close="close">
    <!-- <dept-layout @input="nodeClick" v-model="prisonId" :backData="true">
    <tab right back name="罪犯学习管理" :pathName="'criminal_study_statistics'"></tab>-->
     <div class="laborInfo">
      <div>
        {{details.date}}--
        {{details.prisonName}}--
    ...
    >
      <div slot="searchCondition">
        <!-- <el-form ref="form" class="yn_form" inline :model="details" label-width="10rem">
          <el-row :gutter="10">
            <el-col :span="8">
              <el-form-item label="学习内容:">{{details.studyTitle}}</el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="开始时间:">{{details.beginTime}}</el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="结束时间:">{{details.endTime}}</el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="是否学习日:">
                <span v-if="details.isStudy===0">否</span>
                <span v-else-if="details.isStudy===1">否</span>
                <span v-else-if="details.isStudy===2">是</span>
                <span v-else>暂未配置</span>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="学习地点:">{{details.studyPlace}}</el-form-item>
            </el-col>
            <el-col :span="8">
...
export default {
  ...
  methods: {
    queryPolice() {
      ...
      this.axios
        .get(_globalUrl.businessUrl + '/study/selStudyPolices', {
