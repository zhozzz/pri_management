 ...
 * @LastEditors: zhuhao
 * @LastEditTime: 2020-02-19 17:50:04
 -->
<template>
  <el-dialog
    title="劳动信息新增"
...
export default {
  ...
  props: ['handleCloseAdd', 'addVisible', 'labourTypeOptions', 'fastAddForm'],
  data() {
    return {
  ...
  methods: {
    ...
    getGroupList(id) {
      ...
      this.axios
        .get(_global.businessUrl + '/labour/selLaborPolices', {
    ...
    fastAddForm: {
      ...
      handler(val) {
        ...
        if (val) {
          ...
          this.$set(this.addParams, 'workTime', [
