 ...
 * @LastEditors: zhuhao
 * @LastEditTime: 2019-12-03 17:08:45
 -->
<template>
  <div>
    <el-row :gutter="10">
      ...
      <el-col :span="24">
        <div class="yn_charts">
          <h3>{{prisonName}}各部门引入狱外人员数量统计</h3>
        ...
        <div class="yn_charts">
          ...
          <!-- <el-row>
            <el-form ref="form"
                     ...
                     label-width="4rem">
              <el-form-item label="日期:">
                <el-date-picker v-model="pieFormDate"
                                :clearable="false"
                                type="daterange"
                                :picker-options="pickerOptions"
                                range-separator="至"
        ...
        <div class="yn_charts">
          ...
          <el-row>
            <el-form ref="form"
                     ...
                     label-width="4rem">
              <el-form-item label="日期:">
                <el-date-picker v-model="piePositionFormDate"
                                :clearable="false"
                                :picker-options="pickerOptions"
                                range-separator="至"
                                start-placeholder="开始日期"
              ...
              <el-form-item>
                <el-button type="primary"
                           class="yn_btn"
                           @click="getPiePosition">查询</el-button>
              </el-form-item>
            </el-form>
          </el-row>
          <pie-type-chart v-loading="piePositionLoading"
                          :dataList="piePositionTypeData"
                          :chartData="piePositionTypeData"
                          :height="'20rem'"></pie-type-chart>
        </div>
      </el-col>-->
    </el-row>
  </div>
...
export default {
  ...
  methods: {
    ...
    getBar () {
      ...
      let params = { ...this.params, eventDepartment: this.prisonId }
      getBar(params).then(res => {
        res.forEach(el => {
      ...
      let pieParams = { ...this.params, eventDepartment: this.prisonId }
      getPie(pieParams).then(res => {
      ...
      let areaparams = {}
      areaparams.searchFromDate = this.barFormDate[0]
      areaparams.searchToDate = this.barFormDate[1]
      areaparams.prisonId = this.prisonId
      console.log(areaparams)

      getArea(
        areaparams.searchFromDate +
          '/' +
          areaparams.searchToDate +
          '/' +
          areaparams.prisonId
      ).then(res => {
        let xArr = []
